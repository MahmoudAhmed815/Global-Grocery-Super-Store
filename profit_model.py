...
for col in ['Sales', 'Shipping Cost', 'Discount', 'Quantity', 'Profit']:
    store[col] = (
        store[col]
        .astype(str)
...
x = store[['Sales','Shipping Cost','Discount','Quantity']]
y = store['Profit']
...
rf = RandomForestRegressor(n_estimators=25, random_state=1200, max_depth=5)
